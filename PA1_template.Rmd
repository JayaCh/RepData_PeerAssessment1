...
The 5-minute interval, that contains the maximum munber of steps averaged across all the days in the dataset is `r maxInterval`
...
The mean for the new data with the replaced NA is `r meanStepsPerDay2` and the median is `r medianStepsPerDay2`. This shows that the mean has not changed and the median has been changed with a small shift.
